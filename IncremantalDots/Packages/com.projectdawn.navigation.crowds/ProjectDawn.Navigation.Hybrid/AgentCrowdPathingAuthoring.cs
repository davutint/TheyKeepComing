...
namespace ProjectDawn.Navigation.Hybrid
{
    ...
    public class AgentCrowdPathingAuthoring : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            world.EntityManager.AddComponent<AgentCrowdDisabled>(m_Entity);
            world.EntityManager.SetComponentEnabled<AgentCrowdDisabled>(m_Entity, !enabled);
        }
        ...
        void OnEnable()
        {
            ...
            if (world == null)
                return;
            world.EntityManager.SetComponentEnabled<AgentCrowdDisabled>(m_Entity, false);
        }
        ...
        void OnDisable()
        {
            ...
            if (world == null)
                return;
            world.EntityManager.SetComponentEnabled<AgentCrowdDisabled>(m_Entity, true);
        }
    }
    ...
    internal class AgentCrowdPathingBaker : Baker<AgentCrowdPathingAuthoring>
    {
        public override void Bake(AgentCrowdPathingAuthoring authoring)
        {
            ...
            AddSharedComponent(entity, new AgentCrowdPath { Group = GetEntity(authoring.m_Group, TransformUsageFlags.None) });
            AddComponent<AgentCrowdDisabled>(entity);
            SetComponentEnabled<AgentCrowdDisabled>(entity, !authoring.enabled);
        }
    }
}
