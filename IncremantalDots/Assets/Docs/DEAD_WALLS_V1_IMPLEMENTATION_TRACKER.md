...
> **Aktif iş:** `DW-I-ONBOARD-PREEMPTIVE-COMPLETE` - Complete Steps When the Player Acts Before the Prompt
> **İlerleme:** `369 / 441` tracker checkbox'ı tamamlandı - `%83,67`
...
| Tutorial | İlk Day worker ratio, affordable Basic Archer, low ammo, Castle Heart, regular Council, Day repair ve ilk Night ability-key adımları non-modal pulse, English yönlendirme ve durable meta flag ile aktif; controller transaction/assignment/modal açma çağrısı yapmıyor, blocking pause sırasında cue zinciri kurmuyor ve yedi cue exact ekonomi/worker snapshot regresyonuyla kilitli | `[~]` Package I ilk yedi adım + global transaction-free ve no-modal-chain invariant'ları tamamlandı |
