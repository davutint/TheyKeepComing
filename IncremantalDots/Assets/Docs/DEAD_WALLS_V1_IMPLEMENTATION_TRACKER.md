...
> **Aktif iş:** `DW-V1-CONTRACT-ACTIVE-ABILITY-STATE` - Audit the ActiveAbilityState Source Owner and Close Its Contract
> **İlerleme:** `395 / 442` tracker checkbox'ı tamamlandı - `%89,37`
