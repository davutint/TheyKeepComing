...
| `RunPersistence.cs` | Exact schema v14; minimum v3, compact snapshot, Heart graph, regular Council state ve üç active-ability cooldown'ı; açık v3->v14 migration zinciri |
