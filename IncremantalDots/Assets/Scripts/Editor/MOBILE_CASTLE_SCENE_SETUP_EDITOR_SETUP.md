...
- `FirstRunOnboardingUI`: scene HUD root'ta tek component; `WorkerEconomyDrawerUI`, `MarketUI`, `ArrowSupplyUI`, `HeartScreenUI`, `CouncilEventUI`, `DefenseRepairUI`, `OnboardingHintPanel/Text` ve `OnboardingPulseFrame` referanslari dolu
