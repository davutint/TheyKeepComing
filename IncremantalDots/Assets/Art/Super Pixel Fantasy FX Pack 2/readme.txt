...
Version 1.1 (2/14/25)
	- Added versions of fanfx2_cure which are split into front/back.
...
- (New: Version 1.1) The cure effect has versions which are split into the effect's front half and back half. By drawing them separately at the same position in-game, you can sandwich a character between them and have it appear to be "inside" the effect.
